...
enum CommunityRoute {
  ...
  static String encode(CommunityRoute route) => route.path;

  static CommunityRoute decode(String path) => CommunityRoute.values.firstWhere(
        (e) => e.path == path,
        orElse: () => CommunityRoute.unknown,
      );
}

extension CommunityRouteX on CommunityRoute {
  String get path {
