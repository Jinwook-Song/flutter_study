...
class SearchBlocProvider extends StatelessWidget {
  final Widget child;
  const SearchBlocProvider({super.key, required this.child});
              ...
              providers: [
                ...
                FlowBlocProvider<SearchRecentChannelListCubit>(
                  create: (context) => SearchRecentChannelListCubit(
                    context
                        .readFlowRepository<SetRecentSearchChannelsUseCase>(),
                    context
                        .readFlowRepository<GetRecentSearchChannelsUseCase>(),
                  ),
                ),
