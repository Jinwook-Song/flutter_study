...
abstract class $ProcedureCopyWith<$Res> {
  ...
  @useResult
  $Res call({int recipeId, String name, String image});
}
...
class _$ProcedureImpl implements _Procedure {
  const _$ProcedureImpl(
      {required this.recipeId, required this.name, required this.image});
  ...
  @override
  String toString() {
    return 'Procedure(recipeId: $recipeId, name: $name, image: $image)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, recipeId, name, image);
...
abstract class _Procedure implements Procedure {
  const factory _Procedure(
      ...
      required final String image}) = _$ProcedureImpl;
